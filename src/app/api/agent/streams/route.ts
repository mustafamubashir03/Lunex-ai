...
import { writeToChatHistoryTool } from "@/tools/chatHistoryTool";
      ...
      Always remember past conversation context.`,
        ...
        const stream = new ReadableStream({
            async start(controller) {
                // ✅ STEP 9: Add Abort Handling
                const abort = req.signal;

                // ✅ STEP 11: Add Heartbeat (Safe universal keep-alive)
        ...
        // ✅ STEP 1: Fix SSE Response Headers
