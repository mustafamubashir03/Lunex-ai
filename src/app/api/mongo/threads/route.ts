...
export async function POST(req: NextRequest) {
    try {
        ...
        const result = await createMongoThreadTool.invoke({ threadId, userId })
...
export async function GET(req: NextRequest) {
    try {
        ...
        const result = await getAllMongoThreadsByUserId.invoke({ userId })
...
export async function PATCH(req: NextRequest) {
    try {
        ...
        const updatedThread = await updateMongoThreadTool.invoke({ threadId, userId, title })
